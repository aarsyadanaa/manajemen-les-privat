...
<div class="col-lg-8">
<input readonly class="form-control-plaintext" type="text" value="{{$pic->nama}}">
</div>
</div>
<div class="form-group">
<label class="col-lg-3 control-label">Jabatan:</label>
<div class="col-lg-8">
<input readonly class="form-control-plaintext" type="text" value="{{$pic->jabatan}}">
</div>
</div>
<div class="form-group">
<label class="col-lg-3 control-label">No Telepon:</label>
<div class="col-lg-8">
<input readonly class="form-control-plaintext" type="text" value="{{$pic->no_telp}}">
</div>
</div>
<div class="form-group">
