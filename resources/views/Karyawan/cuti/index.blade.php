...
<td>
<a href="{{ url('/karyawan/cuti/edit/'.$cuti->id) }}" ><button type="submit" class="badge btn-primary mb-1">Edit</button></a>  
<form method="post" action="{{ url('/karyawan/cuti/hapus/'.$cuti->id) }}"> 
    @csrf 
    {{ method_field('delete') }} 
