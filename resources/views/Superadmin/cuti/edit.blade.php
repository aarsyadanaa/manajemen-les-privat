    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
              <h4>Edit Cuti</h4>
                <form role="form" method="post" action="{{ url('/superadmin/cuti/edit/'.$cuti->id) }}">
                    @csrf
                    {{ method_field('PUT') }}
                    <div style="display:flex;">
                        ...
                        <label for="status_2">Status Aksi</label>
                        <select name="status_2" class="c-form-profession form-control" id="c-form-profession" >
					    <option value="{{ $cuti->status_2 }}">{{ $cuti->status_2 }}</option>
