...
<hr class="my-4">     
<a href="cuti/create" class="btn btn-success mb-1">Tambah data Cuti</a>       
<table class="table">
...
<td>
<a href="{{ url('/superadmin/cuti/edit/'.$cuti->id) }}" ><button type="submit" class="badge btn-primary mb-1">Edit</button></a>  
<form method="post" action="{{ url('/superadmin/cuti/hapus/'.$cuti->id) }}"> 
    @csrf 
    {{ method_field('delete') }} 
